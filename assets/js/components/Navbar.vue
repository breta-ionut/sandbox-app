            ...
            <div class="relative flex items-center justify-between h-20">
                ...
                <div class="absolute sm:static inset-y-0 sm:inset-auto right-0 flex items-center sm:ml-6 pr-2 sm:pr-0">
                    <div class="relative ml-3">
                        <div>
                            <button id="user-menu" class="flex bg-white rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-gray-200 focus:ring-offset-2 focus:ring-offset-white" aria-haspopup="true" v-bind:aria-expanded="showUserMenu">
